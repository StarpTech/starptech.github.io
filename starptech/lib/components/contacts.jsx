      ...
      <div className="contacts">
        ...
        <div className="between">
          <div className="socials">
            ...
            {Configs.linkedin && <Link aria-label="linkedin" href={Configs.xing} {...linkProps}>LinkedIn</Link>}
            {Configs.xing && <Link aria-label="xing" href={Configs.xing} {...linkProps}>Xing</Link>}
          </div>
          <div>
